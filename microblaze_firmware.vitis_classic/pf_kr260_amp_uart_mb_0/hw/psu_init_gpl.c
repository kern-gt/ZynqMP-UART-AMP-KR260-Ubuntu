...
/*##################################################################### */
    ...
    */
	PSU_Mask_Write(IOU_SLCR_GEM_CTRL_OFFSET, 0x00000003U, 0x00000001U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180154, 0x03FFFFFFU ,0x00FC0835U)
    */
	PSU_Mask_Write(IOU_SLCR_BANK1_CTRL0_OFFSET,
		0x03FFFFFFU, 0x00FC0835U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180168, 0x03FFFFFFU ,0x0303F7CAU)
    */
	PSU_Mask_Write(IOU_SLCR_BANK1_CTRL6_OFFSET,
		0x03FFFFFFU, 0x0303F7CAU);
/*##################################################################### */
    ...
    * Each bit applies to a single IO. Bit 0 for MIO[52].
    *  PSU_IOU_SLCR_BANK2_CTRL0_DRIVE0_BIT_18                      0

    * Each bit applies to a single IO. Bit 0 for MIO[52].
    *  PSU_IOU_SLCR_BANK2_CTRL0_DRIVE0_BIT_19                      0

    * Each bit applies to a single IO. Bit 0 for MIO[52].
    *  PSU_IOU_SLCR_BANK2_CTRL0_DRIVE0_BIT_20                      0

    * Each bit applies to a single IO. Bit 0 for MIO[52].
    *  PSU_IOU_SLCR_BANK2_CTRL0_DRIVE0_BIT_21                      0

    * Each bit applies to a single IO. Bit 0 for MIO[52].
    *  PSU_IOU_SLCR_BANK2_CTRL0_DRIVE0_BIT_22                      0

    * Each bit applies to a single IO. Bit 0 for MIO[52].
    *  PSU_IOU_SLCR_BANK2_CTRL0_DRIVE0_BIT_23                      0
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180170, 0x03FFFFFFU ,0x0000B00BU)
    */
	PSU_Mask_Write(IOU_SLCR_BANK2_CTRL0_OFFSET,
		0x03FFFFFFU, 0x0000B00BU);
/*##################################################################### */
...
/*##################################################################### */
    ...
    *  PSU_GPIO_DIRM_2_DIRECTION_2                                 0x3000000

    * Direction mode (GPIO Bank2, MIO)
    * (OFFSET, MASK, VALUE)      (0XFF0A0284, 0x03FFFFFFU ,0x03000000U)
    */
	PSU_Mask_Write(GPIO_DIRM_2_OFFSET, 0x03FFFFFFU, 0x03000000U);
/*##################################################################### */
    ...
    *  PSU_GPIO_OEN_2_OP_ENABLE_2                                  0x3000000

    * Output enable (GPIO Bank2, MIO)
    * (OFFSET, MASK, VALUE)      (0XFF0A0288, 0x03FFFFFFU ,0x03000000U)
    */
	PSU_Mask_Write(GPIO_OEN_2_OFFSET, 0x03FFFFFFU, 0x03000000U);
/*##################################################################### */
    ...
    */
    /*
    * Register : MASK_DATA_2_MSW @ 0XFF0A0014

    * Operation is the same as MASK_DATA_0_LSW[MASK_0_LSW]
    *  PSU_GPIO_MASK_DATA_2_MSW_MASK_2_MSW                         0x2ff

    * Operation is the same as MASK_DATA_0_LSW[DATA_0_LSW]
    *  PSU_GPIO_MASK_DATA_2_MSW_DATA_2_MSW                         0x100

    * Maskable Output Data (GPIO Bank1, MIO, Upper 10 bits)
    * (OFFSET, MASK, VALUE)      (0XFF0A0014, 0x03FF03FFU ,0x02FF0100U)
    */
	PSU_Mask_Write(GPIO_MASK_DATA_2_MSW_OFFSET,
		0x03FF03FFU, 0x02FF0100U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * Operation is the same as MASK_DATA_0_LSW[DATA_0_LSW]
    *  PSU_GPIO_MASK_DATA_2_MSW_DATA_2_MSW                         0x0

    * Maskable Output Data (GPIO Bank1, MIO, Upper 10 bits)
    * (OFFSET, MASK, VALUE)      (0XFF0A0014, 0x03FF03FFU ,0x02FF0000U)
    */
	PSU_Mask_Write(GPIO_MASK_DATA_2_MSW_OFFSET,
		0x03FF03FFU, 0x02FF0000U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * Operation is the same as MASK_DATA_0_LSW[MASK_0_LSW]
    *  PSU_GPIO_MASK_DATA_2_MSW_MASK_2_MSW                         0x1ff

    * Operation is the same as MASK_DATA_0_LSW[DATA_0_LSW]
    *  PSU_GPIO_MASK_DATA_2_MSW_DATA_2_MSW                         0x200

    * Maskable Output Data (GPIO Bank1, MIO, Upper 10 bits)
    * (OFFSET, MASK, VALUE)      (0XFF0A0014, 0x03FF03FFU ,0x01FF0200U)
    */
	PSU_Mask_Write(GPIO_MASK_DATA_2_MSW_OFFSET,
		0x03FF03FFU, 0x01FF0200U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * Maskable Output Data (GPIO Bank1, MIO, Upper 10 bits)
    * (OFFSET, MASK, VALUE)      (0XFF0A0014, 0x03FF03FFU ,0x01FF0000U)
    */
	PSU_Mask_Write(GPIO_MASK_DATA_2_MSW_OFFSET,
		0x03FF03FFU, 0x01FF0000U);
/*##################################################################### */
...
unsigned long psu_serdes_init_data(void)
{
    ...
    */
	PSU_Mask_Write(SERDES_PLL_REF_SEL0_OFFSET, 0x0000001FU, 0x0000000FU);
/*##################################################################### */
...
/*##################################################################### */
    ...
    */
	PSU_Mask_Write(SERDES_L0_TM_DIG_6_OFFSET, 0x0000000FU, 0x0000000FU);
/*##################################################################### */
...
/*##################################################################### */
    ...
    */
	PSU_Mask_Write(SERDES_L0_TM_ILL12_OFFSET, 0x000000FFU, 0x00000000U);
/*##################################################################### */
    ...
    */
	PSU_Mask_Write(SERDES_L0_TM_E_ILL1_OFFSET, 0x000000FFU, 0x00000082U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    */
	PSU_Mask_Write(SERDES_L0_TM_E_ILL8_OFFSET, 0x000000FFU, 0x000000FFU);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * SERDES ILL CALIB
    */
		serdes_illcalib(3,0,3,0,4,0,5,0);
...
/*##################################################################### */
    ...
    */
	PSU_Mask_Write(SERDES_ICM_CFG0_OFFSET, 0x00000077U, 0x00000045U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    */
    /*
    * Register : TX_PROT_BUS_WIDTH @ 0XFD410040
    ...
    */
	PSU_Mask_Write(SERDES_TX_PROT_BUS_WIDTH_OFFSET,
		0x00000003U, 0x00000000U);
/*##################################################################### */

    /*
    * Register : RX_PROT_BUS_WIDTH @ 0XFD410044
    ...
    */
	PSU_Mask_Write(SERDES_RX_PROT_BUS_WIDTH_OFFSET,
		0x00000003U, 0x00000000U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    *  width 11: reserved
    *  PSU_LPD_SLCR_AFI_FS_DW_SS2_SEL                              0x1

    * afi fs SLCR control register. Do not change the bits durin
    * (OFFSET, MASK, VALUE)      (0XFF419000, 0x00000300U ,0x00000100U)
    */
...
/*##################################################################### */
    ...
    *  PSU_AFIFM6_AFIFM_RDCTRL_FABRIC_WIDTH                        0x2

    * Read Channel Control Register
    * (OFFSET, MASK, VALUE)      (0XFF9B0000, 0x00000003U ,0x00000002U)
    */
	PSU_Mask_Write(AFIFM6_AFIFM_RDCTRL_OFFSET, 0x00000003U, 0x00000002U);
/*##################################################################### */
    ...
    *  PSU_AFIFM6_AFIFM_WRCTRL_FABRIC_WIDTH                        0x2

    * Write Channel Control Register
    * (OFFSET, MASK, VALUE)      (0XFF9B0014, 0x00000003U ,0x00000002U)
    */
	PSU_Mask_Write(AFIFM6_AFIFM_WRCTRL_OFFSET, 0x00000003U, 0x00000002U);
/*##################################################################### */
